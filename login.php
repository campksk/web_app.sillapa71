        ...
        <center>
          ...
          <div class="row mx-0">
            <div class="col-12 card bg-light mx-auto">
              <h3 class="text-center card-header">เข้าสู่ระบบ</h3>
              <form class="card-body" action="pro_login.php" method="POST">
                <?php
                if(isset($_SESSION['bad_regis'])){
                  echo ('<p style="color: red">'.$_SESSION["bad_regis"].'</p>');
                  $_SESSION["bad_regis"] = null;
                }if(isset($_SESSION['good_regis'])){
                  echo ('<p style="color: green">'.$_SESSION["good_regis"].'</p>');
                  $_SESSION["good_regis"] = null;
                }
                ?>
                ...
                <p class="text-center"><input type="submit" class="btn btn-danger" role="button" value="เข้าสู่ระบบ"></p>
                <a href="regis.php">ยังไม่มีบัญชี คลิกที่นี้</a>
              </form>
            </div>
            </center>
</div>
