        ...
        <center>
          ...
          <div class="row mx-0">
            <div class="col-12 card bg-light mx-auto">
              <h3 class="text-center card-header">สมัครสมาชิก</h3>
              <form class="card-body" action="pro_regis.php" method="POST">
                <?php
                if(isset($_SESSION['bad_regis'])){
                  echo ('<p style="color: red">'.$_SESSION["bad_regis"].'</p>');
                  $_SESSION["bad_regis"] = null;
                }
                ?>
                <div class="form-group row">
                  <label for="pricefrom" class="col-form-label">ชื่อผู้ใช้</label>
                  <div class="input-group">
                    <input type="text" class="form-control" id="pricefrom" aria-describedby="basic-addon1" required placeholder="Username" name="username">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="priceto" class="col-form-label">อีเมล</label>
                  <div class="input-group">
                    <input type="email" class="form-control" id="priceto" aria-describedby="basic-addon2" required placeholder="Email" name="email">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="priceto" class="col-form-label">รหัสผ่าน</label>
                  <div class="input-group">
                ...
                <p class="text-center"><input type="submit" class="btn btn-danger" role="button" value="สมัครสมาชิก"></p>
                <a href="login.php">มีบัญชีอยู่แล้ว คลิกที่นี้</a>
              </form>
            </div>
            </center>
</div>
